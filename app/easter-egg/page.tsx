  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto max-w-4xl px-6 py-16">
        <h1 className="text-4xl font-semibold tracking-tight">🥚 Easter Eggs</h1>
        ...
        <style jsx global>{`
          ...
          @keyframes glitch {
            0% { filter: hue-rotate(0deg) contrast(1.1); transform: translate(0,0); }
            20% { filter: hue-rotate(25deg) contrast(1.3); transform: translate(-1px,0); }
            40% { filter: hue-rotate(-25deg) contrast(1.2); transform: translate(1px,0); }
            60% { filter: hue-rotate(15deg) contrast(1.35); transform: translate(0,1px); }
            80% { filter: hue-rotate(-15deg) contrast(1.25); transform: translate(0,-1px); }
            100% { filter: hue-rotate(0deg) contrast(1.1); transform: translate(0,0); }
          }
          @keyframes melt {
            0% { border-radius: 24px; }
            50% { border-radius: 44px; transform: skewX(-0.4deg) skewY(0.4deg); }
            100% { border-radius: 24px; }
          }
        `}</style>

        <div className="mt-10 text-xs text-white/50">
          Tip: ajoute un lien vers /easter-eggs dans ton StudioPanel (ou un raccourci clavier).
        </div>
      </div>
    </div>
  );
